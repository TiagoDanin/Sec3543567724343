  ...
  collections: {
    ...
    settings: {
      schema: {
        ...
        fields: [
          { name: "eventStartDate", type: "date", includeTime: true, required: true, label: "Início do evento" },
          { name: "eventEndDate", type: "date", includeTime: true, required: true, label: "Fim do evento" },
    ...
    navegacao: {
      schema: {
        ...
        fields: [
          ...
          { name: "grupo", type: "select", label: "Grupo no rodapé", options: [opt("evento", "Evento"), opt("participar", "Participar")] },
    ...
    ingressos: {
      schema: {
        ...
        fields: [
          ...
          { name: "preco", type: "number", format: "integer", required: true, label: "Preço (centavos)" },
          { name: "parcelas", type: "number", format: "integer", label: "Parcelas" },
          { name: "descricao", type: "long-text", rows: 2, label: "Descrição" },
          { name: "validThrough", type: "date", includeTime: true, required: true, label: "Válido até" },
    ...
    agenda: {
      schema: {
        ...
        fields: [
          ...
          { name: "speakerSlug", type: "relation", collection: "palestrantes", label: "Palestrante" },
          {
            name: "status",
            type: "select",
            label: "Situação",
