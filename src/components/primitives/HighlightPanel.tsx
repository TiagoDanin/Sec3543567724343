  ...
  return (
    <div
      className={cn(
        ...
        "bg-linear-120 from-orange/12 to-transparent to-60%",
    ...
    >
      <div>
        {flag ? (
          <p className="bg-orange text-ink mb-5 inline-block px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.16em]">
            {flag}
          </p>
        ) : null}

        {eyebrow ? (
          <p className="text-cream/50 mb-3.5 font-mono text-[11px] font-medium uppercase tracking-[0.24em]">
            {eyebrow}
          </p>
        ) : null}

        <h2 className="font-display text-[clamp(1.5rem,2.6vw,2.125rem)] font-bold leading-[1.16] tracking-[-0.02em]">
          {title}
        </h2>
      </div>
