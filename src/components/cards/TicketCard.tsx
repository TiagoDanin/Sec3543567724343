...
export function TicketCard({
  ...
  return (
    ...
    >
      <p className="tier-name text-cream-3 font-mono text-[12px] uppercase tracking-[0.14em] transition-colors duration-280 ease-brand">
        {name}
      </p>

      <p className="tier-price mt-1.5 font-sans text-[clamp(2rem,3.4vw,2.75rem)] font-bold leading-[1.05] tracking-[-0.02em] tabular-nums transition-colors duration-280 ease-brand">
        {price}
      </p>
